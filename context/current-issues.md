...
The canvas has a dotted background pattern filling the full viewport naturally

The canvas feels flush with the surrounding background — no floating, no card effect

Box-shadow, excessive borders, and elevated styling are removed from the canvas

The canvas looks and feels like an infinite design canvas (similar to Figma or Excalidraw)

Both sidebars float over the canvas and are fully hidden when toggled off
